...
### $k$ Parameter Estimation - In the search to compensate the effects of mutual coupling in measurements and distortions arising from the use of equivalent semi-spherical representation of the horizontal electrode
