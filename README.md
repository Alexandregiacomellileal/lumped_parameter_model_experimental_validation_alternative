...
[Link to Example File]([Link to Example File](example.txt))
https://github.com/Alexandregiacomellileal/lumped_parameter_model_experimental_validation_alternative/blob/main/23_model_rod1.acp
